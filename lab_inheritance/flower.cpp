...
Rectangle *my_stem = new Rectangle(stem_center, STEM_COLOR, STEM_WIDTH, STEM_HEIGHT);
    ...
    // Shape * pistil = new Circle::Circle(const Vector2& pcenter, const HSLAPixel& pcolor, int pradius)
    ...
    // Shape * leaf = new Triangle::Triangle(const HSLAPixel& pcolor, const Vector2& vertex1,
